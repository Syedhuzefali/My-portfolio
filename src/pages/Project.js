  ...
  return (
    <div class="intro">
      ...
      <a href=" https://syedhuzefali.github.io/Portfolio-projects/LUDO/" alt="click here to enter"><button id="click">click</button></a>
        ...
        <a href="https://syedhuzefali.github.io/Portfolio-projects/TIP CALCULATOR" alt="click here to enter"><button id="click">click</button></a>
        ...
        <a href="https://syedhuzefali.github.io/Portfolio-projects/star rating" alt="click here to enter"><button id="click">click</button></a>
        <h4>Star rating</h4>
        <p>
